...
(function () {
    ...
    window.showConfirmDialog = function (options) {
        options = options || {};
        if (!_overlay) { document.addEventListener('DOMContentLoaded', function () { _init(); window.showConfirmDialog(options); }); return; }
    ...
    window.ccConfirmClose = function () { if (_overlay) _close(); };
